      ...
      <div class="flex items-center justify-between">
        <router-link to="/" active-class="text-gray-900" class="text-xl text-gray-600">
          <div class="flex items-center space-x-4">
            <img class="h-12 w-12 object-cover rounded-full" alt="Logo" src="../assets/logo.png" />
            <span class="relative">
              <span class="block absolute -inset-1 -skew-y-3 bg-black" aria-hidden="true"></span>
              <span class="relative text-white text-3xl font-bold">Ch3lonium</span>
            </span>
          </div>
        </router-link>
        ...
        <div class="flex items-center space-x-10">
          <!-- router -->
          <router-link v-for="link in navigation" :key="link.name" :to="link.href" active-class="text-gray-900" exact class="text-gray-600 hover:text-gray-900">
            {{ link.name }}
          </router-link>
